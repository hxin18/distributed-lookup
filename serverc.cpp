...
int main(){
    ...
    while (1){
        ...
        if(strlen > 0){
            ...
            cout<<"The Server C received input <"<<query<<"> and operation <"<<fct<<">"<<endl;
            vector<string> res;
            vector<string> resSimM ;
            vector<string> resSimW ;
            if(!strcmp(fct,"prefix")){
                res = database->retrivePrefix(query);
                cout<<"The Server C has found < "<<res.size()<<" > matches"<<endl;
            }
                ...
                cout<<"The Server C has found < "<<res.size()<<" > matches and < "<<resSimW.size()<<" > similar words"<<endl;
            }
